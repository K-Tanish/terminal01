...
export const Header = React.memo(function Header({ kpi, isPaused, bufferedCount, onTogglePause, onOpenAnalytics, onExport, onToggleSidebar, onToggleHelp }: Props) {
  return (
      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-4 text-xs font-medium">
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1.5">
              <span className={`w-2 h-2 rounded-full ${isPaused ? 'bg-amber-400' : 'bg-green-500 animate-breathe'}`} />
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="bg-[#6b8e23] text-white rounded-xl px-4 h-10 text-[13px] font-bold hover:bg-[#556b2f] transition-colors flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
