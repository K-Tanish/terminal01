...
export const Header = React.memo(function Header({ kpi, isPaused, bufferedCount, onTogglePause, onOpenAnalytics }: Props) {
  return (
        ...
        <div className="flex items-center gap-2">
          ...
          {isPaused && (
            <button
              ...
              className="bg-black text-white rounded-xl px-4 py-2.5 text-[13px] font-bold hover:bg-gray-800 transition-colors flex items-center gap-2"
            >
